...
<body>
    ...
    <main class="webbanner flex" style="background: url(assets/img/car3.jpg) no-repeat right; background-size: cover;">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="banner font">
                        <div class="head-desc ">
                            <span>ALPIS a sua melhor escolha<e>!</e></span>
                            <h1>Conheça <br>a ALPIS<e>.</e></h1>
                        </div>
                        <div class="content-desc flex">
                            <div class="desc">
                                <p>
                                    A Alpis tem o intuito de ser transparente com os compradores <br>
            ...
            <div class="row">
                <div class="col-12">
					...
					<div class="flex font">
                        <div class="aside-70">
                            <div class="head-desc">
                                <h2>Veículo Destaque</h2>
                            </div>
                        </div>
                        <div class="aside-30">
                            <div class="content-desc">
                                <!-- <p>Características do veículo</p>-->
                            </div>
                        </div>
                    </div>
                    <div class="flex font">
						<div class="aside-70">
                            <div class="head-desc">
                                <img src="<%=resultSet.getString("fotoveiculo") %>" alt="">
                                <div class="btn-default spacing">
                                    <a href="automoveis.jsp#veiculos" class="">Ver todos</a>
                                </div>
                            </div>
                        </div>
                        <div class="aside-30 quote">
                            <div class="content-desc">
                                <h3><%=resultSet.getString("modelo_veiculo") %></h3>
                                <p>Características do veículo</p>
                            </div>
                            <div class="features flex">
                                <div class="feature">
                                	<p><b>Marca: <%=resultSet.getString("marca_veiculo") %></b></p>
                                    <p><b>Cor: <%=resultSet.getString("cor_veiculo") %></b></p>
                                    <p><b>Portas: <%=resultSet.getString("portas_veiculo") %></b></p>
                                    <p><b>KM: <%=resultSet.getString("km_veiculo") %></b></p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex font">
                        <div class="aside-70">
                            <div class="head-desc">
                                ...
                                <div class="btn-default spacing">
                                    <a href="javascript:void(0);" class="">Ver agora.</a>
                                </div>
                            </div>
                        </div>
                        <div class="aside-30 quote">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="vehicles font center">
                        <div class="head-desc">
                            <h2>Últimos <br>classificados</h2>
                        </div>
                        <div class="cards flex owl-carousel carouselcar">
                            <%
								try{ 
								connection = DriverManager.getConnection(connectionUrl+dbName, userId, password);
								statement=connection.createStatement();
                        ...
                        <div class="center btn-default spacing">
                            <a href="automoveis.jsp#veiculos" class="">Ver todos os veículos.</a>
                        </div>
                    </div>
                </div>
            </div>
