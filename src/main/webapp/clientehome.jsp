					...
					<div class="superreal_loginform bigformao">
						...
						<div class="unica-acao">
							<div class="title-cardacao">
								<h2>Nossos últimos anúncios</h2>
							</div>
							<div class="cards-carousel-anuncio">
							...
							%>	
								...
								<div class="card-carros">
									<div class="covercarro" style="background-image:url(<%=resultSet.getString("fotoveiculo") %>)"></div>
									<div class="desc-carro">
										<h2><%=resultSet.getString("marca_veiculo") %> - <%=resultSet.getString("modelo_veiculo") %></h2>
										<span><%=resultSet.getString("km_veiculo") %> km</span>
						...
						<div class="unica-acao">
							<div class="title-cardacao">
								<h2>Suas visitas futuras</h2>
							</div>
							<div class="cards_visitas">
								<%

								String group=(String)session.getAttribute("idcliente"); 

									try{ 
										connection = DriverManager.getConnection(connectionUrl+dbName, userId, password);
										statement=connection.createStatement();
										String sql = "select  v.id_visita as id_visita, v.id_veiculo_visita as id_veiculo_visita, v.id_cliente_atrelado as id_cliente_atrelado, v.horario_visita as horario_visita, v.status_visita as status_visita, vei.id_veiculo as id_veiculo, vei.marca_veiculo as marca_veiculo, vei.modelo_veiculo as modelo_veiculo from visita v INNER JOIN veiculos vei ON v.id_veiculo_visita = vei.id_veiculo where status_visita = 1 and id_cliente_atrelado ="+group;
										resultSet2 = statement.executeQuery(sql);
										while(resultSet2.next()){
								%>	
								
									<div class="unicapill-visita">
										<h3>Visita para <%=resultSet2.getString("marca_veiculo") %> - <%=resultSet2.getString("modelo_veiculo") %></h3>
										<span>Marcado para <%=resultSet2.getString("horario_visita") %></span>
										<a data-toggle="modal" data-target="#exampleModal2" href="javascript:void(0)" data-idvisita="<%=resultSet2.getString("id_visita") %>">Cancelar visita</a>
									</div>
						...
						<div class="unica-acao">
							...
							<div class="cards_visitas">
								...
								<%
									...
									String gp2=(String)session.getAttribute("idcliente"); 

									try{ 
										connection = DriverManager.getConnection(connectionUrl+dbName, userId, password);
										statement=connection.createStatement();
										String sql = "select v.id_veiculo_visita as id_veiculo_visita, v.id_cliente_atrelado as id_cliente_atrelado, v.horario_visita as horario_visita, v.status_visita as status_visita, vei.id_veiculo as id_veiculo, vei.marca_veiculo as marca_veiculo, vei.modelo_veiculo as modelo_veiculo from visita v INNER JOIN veiculos vei ON v.id_veiculo_visita = vei.id_veiculo where status_visita = 0 and id_cliente_atrelado ="+gp2;
										resultSet2 = statement.executeQuery(sql);
										while(resultSet2.next()){
								%>	
						...
						<div class="unica-acao">
							...
							<%
									...
									String gp3=(String)session.getAttribute("idcliente"); 

									try{ 
										connection = DriverManager.getConnection(connectionUrl+dbName, userId, password);
										statement=connection.createStatement();
										String sql = "select c.id_veiculo_compra as id_veiculo_compra, c.id_cliente_compra as id_cliente_compra, c.status_compra as status_compra, vei.id_veiculo as id_veiculo, vei.marca_veiculo as marca_veiculo, vei.modelo_veiculo as modelo_veiculo from compra c inner join veiculos vei on c.id_veiculo_compra = vei.id_veiculo where id_cliente_compra ="+gp3;
										resultSet2 = statement.executeQuery(sql);
										while(resultSet2.next()){
								%>	
								
									<div class="unicapill-visita">
										<h3>Compra feita - <%=resultSet2.getString("marca_veiculo") %> - <%=resultSet2.getString("modelo_veiculo") %></h3>
									</div>
