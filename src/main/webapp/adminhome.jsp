            ...
            <div class="row">
                <div class="col-12">
					<div class="superreal_loginform">
						...
						<div class="central-bemvindo">
							<h3>Aqui você poode gerenciair os funcionários e clientes.</h3>
							<div class="btns-actio-administrador">
								<a href="clientes.jsp" target="_blank">Clientes</a><br>
								<a href="cadfuncionario.jsp" target="_blank">Funcionários</a>
							</div>
						</div>
